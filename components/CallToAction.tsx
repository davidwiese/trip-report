		...
		<section className="relative py-20">
			<div className="absolute inset-0">
				<Spotlight
					...
					fill="white"
				/>
				<div className="h-2/3 bg-gradient-to-b from-black via-black to-gray-600 dark:to-black"></div>
				<div className="h-1/3 bg-gradient-to-b from-gray-600 dark:from-black to-gray-200 dark:to-[#191919]"></div>
			</div>
